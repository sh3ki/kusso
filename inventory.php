                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="product_id" name="product_id" required onchange="loadProductIngredients(this.value)">
                                    ...
                                    <?php
                                    try {
                                        $stmt = $pdo->query("SELECT p.id, p.product_name, p.options, p.category_id, c.name as category_name FROM products p LEFT JOIN categories c ON p.category_id = c.id ORDER BY p.product_name");
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (linkFlavorModal) {
                linkFlavorModal.addEventListener('show.bs.modal', function() {
                    // Reset product and size selects
