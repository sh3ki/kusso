                                                    ...
                                                    <?php foreach ($links as $link): ?>
                                                        <div style="display: flex; justify-content: space-between; align-items: center; padding: 3px 0 3px 15px;">
                                                            ...
                                                            <form class="remove-form" onsubmit="handleRemove(event, this)" style="display: inline;">
                                                                ...
                                                                <button type="submit" class="btn btn-sm btn-outline-danger" style="padding: 2px 8px; font-size: 11px;" title="Remove <?php echo htmlspecialchars($link['size'] ?? '16oz'); ?> from category">
            ...
            <div class="card shadow mt-4">
                ...
                <div class="card-body">
                    <ol>
                        ...
                        <li>Click the <strong>✕ button</strong> to remove an ingredient from a category</li>
